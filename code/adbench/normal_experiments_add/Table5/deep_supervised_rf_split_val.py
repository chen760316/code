...
def run(path):
    ...
    #
    # # 初始化随机森林模型
    # random_forest_model_noise = RandomForestClassifier(random_state=42)
    #
    # # 初始化GridSearchCV进行超参数调优，使用验证集进行交叉验证
    # grid_search = GridSearchCV(estimator=random_forest_model_noise, param_grid=param_grid,
    #                            cv=2,  # 5折交叉验证
    #                            scoring='accuracy',  # 使用准确度作为评分指标
    #                            n_jobs=-1,  # 使用所有CPU核进行并行计算
    #                            verbose=2)  # 打印详细的进度信息
    ...
    #
    # # 使用最佳超参数训练模型
    # random_forest_model_noise = grid_search.best_estimator_
    # random_forest_model_noise.fit(X_train_copy, y_train)
    random_forest_model_noise = random_forest_model
    ...
    #
    # # 初始化随机森林模型
    # rf_repair = RandomForestClassifier(random_state=42)
    #
    # # 初始化GridSearchCV进行超参数调优，使用验证集进行交叉验证
    # grid_search = GridSearchCV(estimator=rf_repair, param_grid=param_grid,
    #                            cv=2,  # 5折交叉验证
    #                            scoring='accuracy',  # 使用准确度作为评分指标
    #                            n_jobs=-1,  # 使用所有CPU核进行并行计算
    #                            verbose=2)  # 打印详细的进度信息
    ...
    #
    # # 使用最佳超参数训练模型
    # rf_repair = grid_search.best_estimator_
    # rf_repair.fit(X_train_copy, y_train)
    rf_repair = random_forest_model
