...
func InitLogger(level, projectName, logPath string, maxAge, rotationTime time.Duration, rotationSize uint32, dsn string) {
	initZap(projectName, logPath, maxAge, rotationTime, rotationSize, dsn)
	// 设置打印堆栈深度，设置日志级别
	myLogger = &zapLogger{
