...
for file_path in paths:
    ...
    #
    # # 初始化决策树模型
    # decision_tree_model_noise = DecisionTreeClassifier(class_weight='balanced', random_state=42)
    #
    # # 初始化GridSearchCV进行超参数调优，使用验证集进行交叉验证
    # grid_search = GridSearchCV(estimator=decision_tree_model_noise, param_grid=param_grid,
    #                            cv=2,  # 3折交叉验证
    #                            scoring='accuracy',  # 使用准确度作为评分指标
    #                            n_jobs=-1,  # 使用所有CPU核进行并行计算
    #                            verbose=2)  # 打印详细的进度信息
    ...
    decision_tree_model_noise = decision_tree_model
    ...
    #
    # # 初始化决策树模型
    # decision_tree_repair = DecisionTreeClassifier(class_weight='balanced', random_state=42)
    #
    # # 初始化GridSearchCV进行超参数调优，使用验证集进行交叉验证
    # grid_search = GridSearchCV(estimator=decision_tree_repair, param_grid=param_grid,
    #                            cv=2,  # 3折交叉验证
    #                            scoring='accuracy',  # 使用准确度作为评分指标
    #                            n_jobs=-1,  # 使用所有CPU核进行并行计算
    #                            verbose=2)  # 打印详细的进度信息
    ...
    decision_tree_repair = decision_tree_model
