...
for file_path in paths:
    ...
    #
    # # 使用GridSearchCV进行超参数调优
    # grid_search = GridSearchCV(estimator=softmax_model_noise, param_grid=param_grid,
    #                            cv=2,  # 5折交叉验证
    #                            scoring='accuracy',
    #                            n_jobs=-1,
    #                            verbose=2)
    ...
    softmax_model_noise = softmax_model
    ...
    #
    # # 使用GridSearchCV进行超参数调优
    # grid_search = GridSearchCV(estimator=softmax_repair, param_grid=param_grid,
    #                            cv=2,  # 5折交叉验证
    #                            scoring='accuracy',
    #                            n_jobs=-1,
    #                            verbose=2)
    ...
    #
    # # 使用最佳超参数训练模型
    # softmax_repair = grid_search.best_estimator_
    # softmax_repair.fit(X_train_copy, y_train)
    softmax_repair = softmax_model
