...
for file_path in paths:
    ...
    xgb_clf = xgb_model
    train_label_pred = xgb_clf.predict(X_train)
    test_label_pred = xgb_clf.predict(X_test)
    ...
    print("*" * 100)
    train_label_pred_noise = xgb_model.predict(X_train_copy)
    test_label_pred_noise = xgb_model.predict(X_test_copy)
